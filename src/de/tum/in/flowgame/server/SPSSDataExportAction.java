...
public class SPSSDataExportAction extends DatabaseAction {
	...
	public SPSSDataExportAction() {
		...
		output.append("# user(id,sex,age,personality[1..n]),###,session(id,type,highscore,mood[1..n]),###,gameround(id, asteroids, fuelcans, score, globalRank, socialRank, flow+reqfit[0..1])");
		next();
	}
